...
) else if exist "%LOCALAPPDATA%\WinuxCmd\WinuxCmd-0.5.1-win-x64\winuxcmd.exe" (
    set WINUXCMD_BIN=%LOCALAPPDATA%\WinuxCmd\WinuxCmd-0.5.1-win-x64
) else (
