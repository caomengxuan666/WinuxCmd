...
AppPublisherURL=https://github.com/unixwin/WinuxCmd
AppSupportURL=https://github.com/unixwin/WinuxCmd
AppUpdatesURL=https://github.com/unixwin/WinuxCmd/releases
